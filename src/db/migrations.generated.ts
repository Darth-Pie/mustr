 ...
 * Regenerate with `npm run db:bundle`. Source: drizzle/*.sql (33 files) + src/db/seed-fresh.sql.
...
export const SCHEMA_STATEMENTS: string[] = [
  ...
  `CREATE UNIQUE INDEX \`alliance_invites_token_hash_unique\` ON \`alliance_invites\` (\`token_hash\`)`,
